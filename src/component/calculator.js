    ...
    <div className="calculator-wrapper">
      <div className="calculator-welcome">
        ...
        <img
          ...
          src="https://img.freepik.com/premium-vector/realistic-math-chalkboard-background_23-2148154055.jpg?w=1380"
          alt="math"
        />
      </div>
      <div className="calculator-container">
        ...
        <div className="grid-container">
          <div className="grid-item1">
            <button type="button" className="button" onClick={afterClick}>
              AC
            </button>
          </div>
          ...
          <div className="grid-item4" id="right-side">
            <button type="button" className="button" onClick={afterClick}>
              ÷
            </button>
          </div>
          ...
          <div className="grid-item8" id="right-side">
            <button type="button" className="button" onClick={afterClick}>
              x
            </button>
          </div>
          ...
          <div className="grid-item12" id="right-side">
            <button type="button" className="button" onClick={afterClick}>
              -
            </button>
          </div>
          ...
          <div className="grid-item16" id="right-side">
            <button type="button" className="button" onClick={afterClick}>
              +
            </button>
          </div>
          ...
          <div className="grid-item19" id="right-side">
            <button type="button" className="button" onClick={afterClick}>
              =
            </button>
          </div>
